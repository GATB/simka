...
pdf(file=args[2])
dat_heatmap <- heatmap.2(dat,dendrogram = "none", Rowv=NA,Colv = "Rowv", col = topo.colors(15), scale="none",tracecol=FALSE, margins=c(10,10), key = TRUE, keysize = 1.5 , cexRow = 0.2, cexCol = 0.2, density.info=c("histogram"), breaks = c(2,4,6,8,10,15,20,25,30,35,40,50,60,70,80,100),lhei = c(2, 8));
dev.off()
